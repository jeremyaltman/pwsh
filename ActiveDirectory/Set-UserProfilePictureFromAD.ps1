...
Jeremy Altman
.DESCRIPTION
This script downloads and sets the Active Directory profile photograph for the user account and sets it as your profile picture in Windows.
If no picture exists in AD, choose defaultuser.jpg in \\$env:USERDNSDOMAIN\NETLOGON
.EXAMPLE
Typically called via accompanying VBScript (to hide pwsh window completely) through a GPO
#>
