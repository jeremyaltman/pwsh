...
It will only map the "Shared Documents" library.
.EXAMPLE
Just run this script without any parameters in the users context, but is typically launched via startup script in the "Workstations - OneDrive Automap Team Folders" GPO
.NOTES
...
$client_id = "00000000-0000-0000-0000-000000000000" #App ID
$client_secret = "RandomlyGeneratedPasswordGoesHere%" #API Access Key Password
$tenant_id = "00000000-0000-0000-0000-000000000000" #Directory ID
...
$excludeSiteList = @("Order 66", "Watergate", "Death Star Blueprints")
